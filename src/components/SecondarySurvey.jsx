...
import styles from './SecondarySurvey.styles';

const SecondarySurvey = ({ navigation, route }) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          <Text style={styles.headerTitle}>{t('secondarySurvey.title')}</Text>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.formContainer}>
          <Text style={styles.sectionTitle}>{t('secondarySurvey.detailedAssessment')}</Text>
